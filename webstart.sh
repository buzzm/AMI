...
(cd apps/amiserver ; nohup python3 -u app.py --api_key $OPENAI_API_KEY --ami_cpt ../../ami.cpt  --local_cpt ../../local.cpt --snippets ../../snippets.txt  --numctx 3  --log "$CWD/amiserver.log" > "$CWD/amis2.log"   2>&1 &)
